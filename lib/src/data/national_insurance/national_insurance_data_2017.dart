...
class NationalInsuranceData2017 extends NationalInsuranceData{

  num C1LowerEarningsLimit = 5832;
  num C1PrimaryThreshold = 8064;
  num C1SecondaryThreshold = 8112;
  num C1UpperAccrualPoint = 40044;
  num C1UpperEarningsLimit = 42996;
  num C1UpperSecondaryThreshold = 42996;
